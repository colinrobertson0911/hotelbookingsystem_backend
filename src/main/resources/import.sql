...
insert into bookings(bookingId, checkInDate, checkOutDate, roomType, extras, hotel, roomPrice, extrasPrice, totalPrice) values (BOOKING_SEQ.nextval, TO_DATE('2020/04/23', 'yyyy/mm/dd'), TO_DATE('2020/04/27', 'yyyy/mm/dd'), 'STANDARD', 'AIRPORTTRANSFER', 'Travellodge Glasgow', '60.00', '20.00','440.00');
insert into bookings(bookingId, checkInDate, checkOutDate, roomType, extras, hotel, roomPrice, extrasPrice, totalPrice) values (BOOKING_SEQ.nextval, TO_DATE('2020/04/15', 'yyyy/mm/dd'), TO_DATE('2020/04/25', 'yyyy/mm/dd'), 'STANDARD', 'AIRPORTTRANSFER', 'Travellodge Glasgow', '60.00', '20.00','440.00');
